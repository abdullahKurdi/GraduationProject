<?php
    ...
    if(isset($_SESSION['Username'])){
        include 'init.php';
/**********************************************************************************/
        $do = isset($_GET['do']) ? $_GET['do'] : 'ManageBidding';
                    ...
                    <div class="card " >
                        <div class="row">
                            <div class="ar col-lg-4">
                                <img src="uploads/profile_pic/<?php echo $UserInformaion[0]['ProfilePic'];?>" alt="...">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
                    ...
                    <div class="row ItemPic">
                        <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel" data-touch="false" data-interval="false">
                            ...
                            <div class="carousel-item active">
                                <img src="uploads/item_pic/<?php echo $imgs[0];?>" class="d-block img_item" alt="...">
                            </div>
                                <?php for($t = 1 ; $t < $img_count ; $t++){?>
                                <div class="carousel-item" data-interval="10000">
                                    <img src="uploads/item_pic/<?php echo $imgs[$t];?>" class="d-block w-100" alt="...">
                                </div>
                                <?php }?>
                            </div>
        ...
        <?php }elseif($do == 'InsertAds'){
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if (empty($formErrors)){
                    ...
                    move_uploaded_file($Pic_tmp,"uploads\Ads_pic\\".$Ads_Pic);
